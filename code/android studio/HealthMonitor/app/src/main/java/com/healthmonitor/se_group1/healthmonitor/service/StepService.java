package com.healthmonitor.se_group1.healthmonitor.service;
...
import com.healthmonitor.se_group1.healthmonitor.view.stepcounter;
...
public class StepService extends Service implements SensorEventListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
         ...
         * 总之有需要的可以和我交流
         */
        nfIntent = new Intent(this, stepcounter.class);
        builder.setContentIntent(PendingIntent.getActivity(this, 0, nfIntent, 0)) // 设置PendingIntent
                .setLargeIcon(BitmapFactory.decodeResource(this.getResources(), R.mipmap.ic_launcher)) // 设置下拉列表中的图标(大图标)
                .setContentTitle("today"+CURRENT_STEP+"step") // 设置下拉列表里的标题
                .setSmallIcon(R.mipmap.ic_launcher) // 设置状态栏内的小图标
                .setContentText("keep exercise"); // 设置上下文内容
        // 获取构建好的Notification
