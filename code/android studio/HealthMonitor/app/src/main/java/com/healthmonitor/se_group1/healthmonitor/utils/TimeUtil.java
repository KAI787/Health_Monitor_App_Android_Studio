package com.healthmonitor.se_group1.healthmonitor.utils;
...
public class TimeUtil {
    ...
    private static String[] weekStrings = new String[]{"Sun","Mon", "Tue", "Wed", "Thu", "Fri", "Sta"};
    private static String[] rWeekStrings = new String[]{"Sun","Mon", "Tue", "Wed", "Thu", "Fri", "Sta"};
    ...
    public static String getCurTime(){
        ...
        String time = "Today "+dFormat.format(System.currentTimeMillis());
        return time;
    }
