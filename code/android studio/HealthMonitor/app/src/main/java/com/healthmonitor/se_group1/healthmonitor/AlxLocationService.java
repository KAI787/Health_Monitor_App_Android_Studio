    ...
    private void updateLocation() {
        ...
        if ((locationProvider != null) && (!locationProvider.equals("")) && (PROVIDER_ARRAY.contains(locationProvider))) {
            try {
                ...
                Log.i("AlexLocation","longitude"+currentLocation.getLongitude()+" latitude"+currentLocation.getLatitude()+"  provider"+locationProvider);
                if(AlxLocationManager.isDebugging) Toast.makeText(getApplicationContext(),"get"+"longitude"+currentLocation.getLongitude()+" latitude"+currentLocation.getLatitude(), Toast.LENGTH_LONG).show();
                ...
                if (currentLocation != null) {
                    ...
                    Log.i("AlexLocation", "locationProvider -> " + newLatitude + " : " + newLongitude + "accuracy"+accuracy);
