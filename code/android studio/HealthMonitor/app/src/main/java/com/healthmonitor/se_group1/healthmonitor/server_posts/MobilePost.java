package com.healthmonitor.se_group1.healthmonitor.server_posts;
...
import com.healthmonitor.se_group1.healthmonitor.server_config.ServerConfig;
...
public class MobilePost extends AsyncTask<PostData, Integer, Boolean> {
    ...
    protected Boolean doInBackground(PostData... params) {
        ...
        if (content_type_in == ContentType.JSON.ordinal()) {
            ...
            throw new Error(String.format(BAD_CONTENT_TYPE, content_type_in));
        }
